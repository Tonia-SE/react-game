...
export const SettingsPage: React.FC = () => {
  ...
  switch (soundsDefaultVolumeLevel) {
    case 100:
      soundOnImgClassName = 'off-img';
      soundOffImgClassName = 'on-img';
      break;
    case 0:
      soundOnImgClassName = 'on-img';
  ...
  switch (musicDefaultVolumeLevel) {
    case 100:
      musicOnImgClassName = 'off-img';
      musicOffImgClassName = 'on-img';
      break;
    case 0:
      musicOnImgClassName = 'on-img';
            ...
            <ListGroup variant="flush">
              <ListGroup.Item
                ...
                <input
                  ...
                  id="4"
                  value="4"
                  name="settings_page_difficulty"
                  defaultChecked={gameSize === 4}
                  onChange={() => {
                    dispatch({ type: SET_GAME_SIZE, gameSize: 4 });
                    dispatch({ type: RESTART_GAME });
                    buttonSoundsPlayer.play();
            ...
            <Card.Body className="my-card-body">
              ...
              <Form>
                <Form.Group className="range-group" controlId="formBasicRangeSounds">
                  <img
                    className={`control-img mr-3 ml-1 ${soundOnImgClassName}`}
                  ...
                  <Form.Control
                    ref={(element: HTMLInputElement) => {
                      soundsVolumeControl = element;
                    }}
                    type="range"
                    defaultValue={soundsDefaultVolumeLevel}
                    onChange={(event) => {
                      dispatch({ type: SET_SOUNDS_VOLUME, soundsVolume: +event.currentTarget.value });
                    }}
                  />
                  <img
                    className={`control-img ml-3 mr-1 ${soundOffImgClassName}`}
            ...
            <Card.Body className="my-card-body">
              ...
              <Form>
                <Form.Group className="range-group">
                  <img
                    className={`control-img mr-3 ml-1 ${musicOnImgClassName}`}
                  ...
                  <Form.Control
                    ref={(element: HTMLInputElement) => {
                      musicVolumeControl = element;
                    }}
                    type="range"
                    defaultValue={musicDefaultVolumeLevel}
                    onChange={(event) => {
                  ...
                  />
                  <img
                    className={`control-img ml-3 mr-1 ${musicOffImgClassName}`}
